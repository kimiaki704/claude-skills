...
実務の意思決定・知見の中に眠っている「発信価値のある情報」を発掘し、LT・ブログ・Twitter スレッドなど
...
|---------|---------|---------|---------|
| ADR カタログ | スキャン→スコアリング | 社内情報チェック | チャネル選択後に整形 |
| 会話ベース | 発掘のアンテナで抽出 | 社内情報チェック | チャネル選択後に整形 |
| **ネタ指定** | **スキップ**（ネタは確定済み）| 社内情報チェック | チャネル指定済みなら即整形、未指定なら確認 |
...
| チャネルが未指定 | 「どのチャネル向けに整形しますか？」を AskUserQuestion で確認する |
